// src/app/profil/waka-ismuba/components/WakaIsmubaTeam.tsx
"use client";
...
import { POKJA_ISMUBA } from "../../libs/data";
import { MapPin, GraduationCap, CalendarDays } from "lucide-react";

export default function WakaIsmubaTeam() {
  const TEAM = POKJA_ISMUBA;
        ...
        {TEAM.map((m) => (
          ...
          >
            ...
            <CardHeader className="mt-4 w-full p-0">
              <CardTitle
                className="
                  mx-auto max-w-[22ch] text-center text-xl font-semibold leading-snug text-gray-900
                  [text-wrap:balance]
                "
              >
                {m.name}
